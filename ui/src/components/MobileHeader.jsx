...
export default function MobileHeader({children}) {
    ...
    return (
        <div className="sticky top-0 pt-3 pb-2 sm:pt-2 pb-1 backdrop-blur bg-zinc-100 dark:bg-zinc-800 bg-opacity-70 flex md:hidden flex-row justify-between items-center w-full h-auto flex-nowrap shrink-0 z-2 " >
